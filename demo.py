...
# Combined extraction function for weather, alarm, and event details
def extract_details(command):
    ...
    return intent, location, action, name, time, event_name, event_date, event_time


# Handle commands based on the extracted details
def process_command():
    global is_listening
    wish_me()
    while is_listening:
